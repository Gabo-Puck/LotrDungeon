...
namespace LotrDungeon.Models.Entities
{
    ...
    {
        public override string Classifier => "Human";
        ...
        public Human(string _Name, Stats basicStats, List<BaseAccesory> _Accesories, List<BaseWeapon> _Weapons, List<BaseDefense> _Defense) : base(_Name, basicStats, _Accesories, _Weapons, _Defense)
        {
        }
